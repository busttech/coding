...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql://tarun:xXc5Ld9kyVJ75PaZsX9uKJU5iV0WiUhb@dpg-ct4je4jtq21c7393ug4g-a/co12"
...
def login():
    if request.method == 'POST':
        ...
        if username == 'teacher' and password == '329330':
